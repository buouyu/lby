$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*欢迎你，我的朋友。我是小鱼，是个还算年轻的网络小白</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*小鱼非妄自尊称，纯属卖萌o(￣▽￣)d</div>",2000);
	...
	w.load("<p><div class='writecode'>BUOUYU</div>");
	w.load("<div class='writecode'>Single dog</div>");
	w.load("<div class='writecode'>小鱼、热爱网络的小白</div></p>");
	w.load("<div class='writecode'>个人Q号:1879153421</div></p>");
	w.load("<h1 class='writecode'>联系</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>Mail:<a href='javascript:void(0);' target='_blank'>1879153421@qq.com</li>");
	w.load("<li class='writecode'>Blog:<a href='http://blog.fuckmx.tk' target='_blank'>https://buouyu.github.io/lby/</a></li>");
	w.load("</ul>");
