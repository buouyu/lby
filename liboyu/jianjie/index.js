$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*欢迎你，我的朋友。我是博雨，是个还算年轻的网络小白</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*博雨非妄自尊称，纯属卖萌o(￣▽￣)d</div>",2000);
	...
	w.load("<p><div class='writecode'>Li Boyu</div>");
	w.load("<div class='writecode'>Single dog</div>");
	w.load("<div class='writecode'>博雨、热爱网络的小白</div></p>");
	w.load("<div class='writecode'>个人Q号:1879153421</div></p>");
	w.load("<h1 class='writecode'>联系</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>Mail:<a href='javascript:void(0);' target='_blank'>1310357569@qq.com</li>");
	w.load("<li class='writecode'>Blog:<a href='http://blog.fuckmx.tk' target='_blank'>http://liboyu.cp.mfweb.xyz/aixin/my.html</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>能用html+css+javascript日常开发</li>");
	w.load("<li class='writecode'>熟练html框架使用</li>");
    w.load("<li class='writecode'>对ni情有独钟</li>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ:1879153421</div>");
	c.load("<div class='comment writecode'>&nbsp;*Mail:1879153421qq.com</div>");
